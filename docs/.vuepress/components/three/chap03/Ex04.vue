<template>
    <div class="example">
        <div id="dom_chap03_ex04" style="width:100%; height:100%"></div>
    </div>
</template>
...
onMounted(()=>{
    const container = document.getElementById('dom_chap03_ex04');
    if(!container)
        return;
    ...
    gui.add(controls, 'lightIntensity',0,50).onChange(function (e) {
