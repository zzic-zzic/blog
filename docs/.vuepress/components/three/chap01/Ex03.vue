<template>
    <div class="example">
        <div id="dom_chap01_ex03" style="width:100%; height:100%"></div>
    </div>
</template>
...
onMounted(()=>{
    const container = document.getElementById('dom_chap01_ex03');
    if(!container)
        return;

    threeLayer = new ThreeLayer('chap01-ex03', container);
